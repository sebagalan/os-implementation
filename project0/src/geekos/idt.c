...
void Init_IDT(void)
{
	...
	Print("Initializing IDT...\ng_handlerSizeNoErr %i\ng_handlerSizeErr %i\ng_entryPointTableEnd %li\ntableBaseAddr %li \n g_entryPointTableEnd-g_entryPointTableStart %i\n g_handlerSizeNoErr*NUM_IDT_ENTRIES %i\n",g_handlerSizeNoErr,
			g_handlerSizeErr, (ulong_t)&g_entryPointTableEnd , tableBaseAddr,
			(&g_entryPointTableEnd - &g_entryPointTableStart), g_handlerSizeNoErr*NUM_IDT_ENTRIES );
